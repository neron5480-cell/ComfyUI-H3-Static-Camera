...
VRAM-friendly (8 GB+) — стабильная работа даже на бюджетных картах
Zero bloat — чистый Python/PyTorch, не ломается при обновлениях ComfyUI
Anti-spaghetti — заменяет цепочки из 5–10 обычных нод одним удобным блоком
